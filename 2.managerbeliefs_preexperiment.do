...
clear all
log using "${main_loc}/_paper/results/managerial_beliefs_draft.log", replace
...
gr export "${main_loc}/_paper/results/figures/managers_money_and_nonmoney_incentives_matter.eps", replace
...
gr export "${main_loc}/_paper/results/figures/managers_overallaveragerank_maximizingrevs.eps", replace
...
gr export "${main_loc}/_paper/results/figures/managers_why_choices_base.eps", replace
...
gr export "${main_loc}/_paper/results/figures/managers_mostpreferredscheme.eps", replace
...
gr export "${main_loc}/_paper/results/figures/managers_overallaveragerank_dropouts.eps", replace
...
gr export "${main_loc}/_paper/results/figures/managers_why_choices_droupouts.eps", replace
